...
class Automate:
  ...
  def __init__(self, nom, etats=None, transitions=None):
    ...
    self.is_determinist = self.est_deterministe()
...
def construire_automate_thompson(postfix_expression):
    stack = []
...
# expression = "a+b*"
# postfix_expression = infix_to_postfix(expression)
# nfa = construire_automate_thompson(postfix_expression)
# afficher_automate(nfa)
